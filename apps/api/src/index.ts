...
import { storeProductCreate, storeProductToggle, storeProductDetail, storeProductList, storeProductUpdate, storeProductAction } from './controllers/store-product.js';
...
import { adminProductAction, adminProductDetail, adminProductFeatured, adminProductList, adminProductPublish, adminProductToggle, adminProductUpdate } from './controllers/admin/product.js';
...
userRoute.post('/stores/products/actions', hasStore, storeProductAction)
...
adminRoute.post('/products/actions', adminProductAction)
