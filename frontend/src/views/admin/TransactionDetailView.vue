...
<template>
  <div>
    <div class="d-flex" v-if="!isFetching">
      <h5 class="mb-4">Transaksi #{{ route.params.id }}</h5>
      <div class="ms-auto">
        <RouterLink to="/admin/all-transactions" class="small">
          &larr; Transaksi
        </RouterLink>
      </div>
    </div>
      ...
      <div v-else>
        ...
        <div class="card mb-4">
          ...
          <ul class="list-group list-group-flush">
            ...
            <li v-if="['in_process', 'sent', 'complained'].includes(order.status)" class="list-group-item">
